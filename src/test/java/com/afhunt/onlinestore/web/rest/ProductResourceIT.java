package com.afhunt.onlinestore.web.rest;

import static com.afhunt.onlinestore.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.afhunt.onlinestore.IntegrationTest;
import com.afhunt.onlinestore.domain.Product;
import com.afhunt.onlinestore.domain.enumeration.Sizeproduct;
import com.afhunt.onlinestore.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final Sizeproduct DEFAULT_SIZEPRODUCT = Sizeproduct.S;
    private static final Sizeproduct UPDATED_SIZEPRODUCT = Sizeproduct.M;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .price(DEFAULT_PRICE)
            .sizeproduct(DEFAULT_SIZEPRODUCT)
            .image(DEFAULT_IMAGE)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .price(UPDATED_PRICE)
            .sizeproduct(UPDATED_SIZEPRODUCT)
            .image(UPDATED_IMAGE)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSizeproduct()).isEqualTo(DEFAULT_SIZEPRODUCT);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizeproduct").value(hasItem(DEFAULT_SIZEPRODUCT.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sizeproduct").value(DEFAULT_SIZEPRODUCT.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getSizeproduct()).isEqualTo(UPDATED_SIZEPRODUCT);
